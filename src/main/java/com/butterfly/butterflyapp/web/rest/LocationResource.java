...
public class LocationResource {
    ...
    @GetMapping("/locations/getAllData/{id}")
    public List<Location> getAllData(@PathVariable Long id){
    	
    	
    	return locationService.findByDistrictId(id);
    } 
    @GetMapping("/locations/getOne/{id}")
    public Location getOneData(@PathVariable Long id){
